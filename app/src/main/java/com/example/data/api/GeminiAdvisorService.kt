...
class GeminiAdvisorService {
    ...
    private fun getOfflineVerifiedAdvice(prompt: String, profile: BusinessProfile?, language: String): String {
        ...
        if (language == "हिन्दी" || prompt.contains("डेयरी") || prompt.contains("ऋण") || prompt.contains("लोन")) {
            return if (isDairy) {
                """
                ...
                **2. अनुमानित निवेश एवं वित्तीय ढांचा:**
                • कुल आवश्यक निवेश: ₹%,d
                • आपकी स्वयं की पूंजी: ₹%,d (10%)
                • आवश्यक सरकारी ऋण: ₹%,d (90%)

                **3. अनुशंसित सरकारी योजना:**
                • **NSFDC टर्म लोन योजना**: ब्याज दर मात्र 6%% वार्षिक (महिलाओं हेतु 5%%)।
                ...
                **4. आवश्यक आधिकारिक दस्तावेज:**
                ...
                • तहसीलदार द्वारा जारी जाति प्रमाण पत्र (SC) एवं आय प्रमाण पत्र (< ₹3 लाख)
                ...
                **5. अगला कदम:**
                ...
                """.trimIndent().format(totalInv, ownCap, loanReq)
            } else {
                """
                ...
                **3. आवेदन प्रक्रिया:**
                ...
                """.trimIndent().format(totalInv, loanReq)
            }
        }
        ...
        return if (isDairy) {
            ...
            **3. Financial Estimates & Viability:**
            ...
            • Your Equity Contribution: **₹%,d** (10%)
            • Required Government Loan: **₹%,d**
            • Monthly Gross Milk Revenue: **₹%,d**
            • Monthly Feed & Care Expenses: **₹%,d**
            • Projected Monthly Net Profit: **₹%,d** (Comfortably covers concessional EMI).
            ...
            **2. Financial Architecture:**
            • Total Investment: **₹%,d**
            • Promoter Capital: **₹%,d**
            • Government Financing Required: **₹%,d**
